		...
		<div ref={scrollRef}>
			...
			>
				...
				>
					...
					<h1>
					I am a goal-oriented, Excited to become an integral part of an organization.
					</h1>
					<div className={styles.btn}>
						<a
							href='https://drive.google.com/file/d/14vkWQueNF5_qV5vBsVtYvDhnPmuaPyhF/view?usp=sharing' // Resume
							target='blank'
						>
							<Button
								text={
				...
				>
					<img
						src='https://i.postimg.cc/6pKwMhZP/IMG-20220109-112442.jpg' //my Picture
						alt='Profile pic'
					/>
				</div>
			</div>
