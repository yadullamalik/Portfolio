    ...
    >
      <div className={styles.container}>
        ...
        >
          ...
          <a
            href="mailto: shaikyadullamalik123@gmail.com"
            aria-label="email"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://github.com/yadullamalik"
            aria-label="GitHub"
            rel="noreferrer"
            target="_blank"
          >
          ...
          <a
            href="https://www.linkedin.com/in/yadulla-malik-shaik-07258b226/"
            aria-label="Linkedin"
            target="_blank"
            rel="noreferrer"
          >
      ...
      <div style={{ color: `${newTheme.para}` }} className={styles.copyright}>
        Designed and build by Rahul Hooda, 2022 All rights reserved.
      </div>
    </footer>
  );
};
